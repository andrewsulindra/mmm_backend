        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="{{ url('/customer/create') }}" class="btn btn-primary">Add New</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td class="project-actions text-right">
                    @if(!empty($data->is_active == '1'))
                    <a class="btn btn-info btn-sm" href="{{ url('customer/' . $data->id) }}">
                        <i class="fas fa-pencil-alt"></i>
                        Edit
                    </a>
                    <a class="btn btn-danger btn-sm" href="{{ url('customer/' . $data->id) . '/deactivate'}}" onclick="return confirm('Are you sure want to deactivate this user?')">
                      <i class="far fa-times-circle"></i>
                        Deactivate
                    </a>
                    @elseif(!empty($data->is_active == '0'))
                    <a class="btn btn-secondary btn-sm" href="{{ url('customer/' . $data->id) . '/reactivate'}}" onclick="return confirm('Are you sure want to reactivate this user?')">    
